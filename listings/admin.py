...
class ListingAdmin(admin.ModelAdmin):
    ...
    list_display = ("id", "title", "district", "rooms", "is_published", "rooms", "doctor", "tag_list", "display_professions")
    list_display_links = ("id", "title")
    list_filter = ("doctor", "services")
    search_fields = ("title", "district", "doctor__name", "serives__name", "professions__name")
    list_per_page = 25
    ...
    def display_professions(self, obj):
        return ', '.join([subject.name for subject in obj.professions.all()]) or "Name"
